...
@RequestMapping("/api/v1/lithography")
public class LithographyController {

  private final CalculateService<ProjectStep, CostRequestDto, LithographyRequestDto> service;

  @PostMapping
  public ApiResponseDto<ResultResponseDto> calculate(
      @Valid @RequestBody LithographyRequestDto request) {
