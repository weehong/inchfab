...
@RequestMapping("/api/v1/rie")
public class RieController {

  private final CalculateService<ProjectStep, CostRequestDto, RieRequestDto> service;

  @PostMapping
  public ApiResponseDto<ResultResponseDto> calculate(
      @Valid @RequestBody RieRequestDto request) {
