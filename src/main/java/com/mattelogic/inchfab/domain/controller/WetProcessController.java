...
@RequestMapping("/api/v1/wet-process")
public class WetProcessController {

  private final CalculateService<ProjectStep, CostRequestDto, WetProcessRequestDto> service;

  @PostMapping
  public ApiResponseDto<ResultResponseDto> calculate(
      @Valid @RequestBody WetProcessRequestDto request) {
