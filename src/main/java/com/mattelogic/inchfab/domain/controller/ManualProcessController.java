...
@RequestMapping("/api/v1/manual-process")
public class ManualProcessController {

  private final CalculateService<ProjectStep, CostRequestDto, ManualProcessRequestDto> service;

  @PostMapping
  public ApiResponseDto<ResultResponseDto> calculate(
      @Valid @RequestBody ManualProcessRequestDto request) {
