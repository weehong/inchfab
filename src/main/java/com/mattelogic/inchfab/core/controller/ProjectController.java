...
public class ProjectController {
  ...
  public ResponseEntity<ApiResponseDto<ProjectResponseDto>> create(
    ...
    log.debug("REST request to save Project : {}", projectRequestDto);
    return ResponseEntity
        .status(HttpStatus.CREATED)
        .body(projectService.create(projectRequestDto));
  }
  ...
  public ResponseEntity<ApiResponseDto<ProjectResponseDto>> createDraft(
    ...
    log.debug("REST request to save draft Project : {}", projectRequestDto);
    return ResponseEntity
        .status(HttpStatus.CREATED)
        .body(projectService.create(projectRequestDto));
  }
  ...
  public ResponseEntity<ApiResponseDto<ProjectResponseDto>> update(
    ...
    log.debug("REST request to update Project : {}, {}", id, projectRequestDto);
