...
public class CompanyController {
  ...
  private final GenericService<CompanyResponseDto, CompanyRequestDto> companyService;
  ...
  public ResponseEntity<ApiResponseDto<CompanyResponseDto>> create(
    ...
    log.debug("REST request to save Company : {}", companyRequestDto);
    return ResponseEntity
        .status(HttpStatus.CREATED)
        .body(companyService.create(companyRequestDto));
  }
  ...
  public ResponseEntity<ApiResponseDto<CompanyResponseDto>> update(
    ...
    log.debug("REST request to update Company : {}, {}", id, companyRequestDto);
